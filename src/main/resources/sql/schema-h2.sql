...
(
    ...
    row             VARCHAR(10) NOT NULL COMMENT 'A-Z',
    col             NUMBER      NOT NULL,
    created_at      TIMESTAMP   NOT NULL DEFAULT CURRENT_TIMESTAMP,
    last_updated_at TIMESTAMP   NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (id)
...
CREATE INDEX IF NOT EXISTS IDX_BOKKINGS_MEMBER_ID ON BOOKINGS (member_id);
...
CREATE INDEX IF NOT EXISTS IDX_BOKKING_ITEMS_BOOKING_ID ON BOOKING_ITEMS (booking_id);
